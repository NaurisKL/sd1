            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.conferences.store') }}">
                        ...
                        <div class="form-group row mb-3">
                            <label for="capacity" class="col-md-4 col-form-label text-md-right">Capacity (Optional)</label>
                            <div class="col-md-6">
                                <input id="capacity" type="number" min="1" class="form-control @error('capacity') is-invalid @enderror" 
